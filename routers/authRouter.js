...
router.post("/registration", [
	...
	check("email", "Имя должно быть больше 3 и меньше 70 символов").isLength({ min: 3, max: 70 }),
	check("password", "Имя должно быть больше 8 и меньше 70 символов").isLength({ min: 8, max: 70 }),
